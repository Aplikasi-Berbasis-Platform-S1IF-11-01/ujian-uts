    ...
    <table class="admin-table">
        ...
        <tbody>
            ...
            <tr id="contact-row-<?php echo e($contact->id); ?>">
                <td><code style="font-size:12px;background:var(--bg);padding:2px 8px;border-radius:6px"><?php echo e($contact->type); ?></code></td>
                <td><strong style="color:var(--ink)"><?php echo e($contact->label); ?></strong></td>
                <td style="color:var(--muted)"><?php echo e($contact->value); ?></td>
                <td style="max-width:150px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis"><a href="<?php echo e($contact->url); ?>" target="_blank" style="color:var(--accent);font-size:12px"><?php echo e($contact->url); ?></a></td>
                <td>
                    <span style="display:inline-block;width:14px;height:14px;border-radius:50%;background:<?php echo e($contact->icon_bg); ?>;border:2px solid <?php echo e($contact->icon_color); ?>;vertical-align:middle"></span>
                </td>
                <td>
                    <div style="display:flex;gap:6px">
                        <button class="btn-outline-accent" onclick="openModal(<?php echo e($contact->id); ?>,'<?php echo e($contact->type); ?>','<?php echo e($contact->label); ?>','<?php echo e(addslashes($contact->value)); ?>','<?php echo e(addslashes($contact->url)); ?>','<?php echo e($contact->icon_bg); ?>','<?php echo e($contact->icon_color); ?>',<?php echo e($contact->sort_order); ?>)">Edit</button>
                        <button class="btn-danger-sm" onclick="deleteContact(<?php echo e($contact->id); ?>)">Hapus</button>
                    </div>
                </td>
            </tr>
...
async function saveContact() {
    ...
    const apiUrl = id ? `/admin/contacts/${id}` : '<?php echo e(route("admin.contacts.store")); ?>';
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MATKUL SEMS 6\PRAKTIKUM ABP\webpro\webprofile\resources\views/admin/contacts.blade.php ENDPATH**/ ?>