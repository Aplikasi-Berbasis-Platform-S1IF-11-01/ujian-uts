...
<body>
    ...
    <nav>
        <div class="nav-inner">
            ...
            <a href="<?php echo e(route('login')); ?>" class="nav-admin">Admin ↗</a>
        </div>
    </nav>
    ...
    <script>
        ...
        async function loadProfile() {
            try {
                const res = await fetch('<?php echo e(route('api.profile')); ?>');
    ...
    `;
                ...
                photoWrap.innerHTML = `<img src="<?php echo e(asset('images/foto.PNG')); ?>" class="hero-photo" alt="Foto Profil">`;
        ...
        async function loadSkills() {
            try {
                const res = await fetch('<?php echo e(route('api.skills')); ?>');
                const json = await res.json();
                if (!json.success) return;
    ...
    `).join('');
        ...
        async function loadEducation() {
            try {
                const res = await fetch('<?php echo e(route('api.education')); ?>');
                const json = await res.json();
                if (!json.success) return;
    ...
    `).join('');
        ...
        async function loadProjects() {
            try {
                const res = await fetch('<?php echo e(route('api.projects')); ?>');
                const json = await res.json();
                if (!json.success) return;
    ...
    `).join('');
        ...
        async function loadContacts() {
            try {
                const res = await fetch('<?php echo e(route('api.contacts')); ?>');
                const json = await res.json();
                if (!json.success) return;
...
<?php /**PATH D:\MATKUL SEMS 6\PRAKTIKUM ABP\webpro\webprofile\resources\views/portfolio/index.blade.php ENDPATH**/ ?>