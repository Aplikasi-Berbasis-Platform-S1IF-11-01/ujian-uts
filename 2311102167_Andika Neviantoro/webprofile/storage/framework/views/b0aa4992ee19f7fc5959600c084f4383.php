<?php $__env->startSection('title', 'Kelola Project'); ?>
<?php $__env->startSection('page-title', 'Kelola Project'); ?>
    ...
    <table class="admin-table">
        ...
        <tbody id="projects-tbody">
            ...
            <tr id="project-row-<?php echo e($project->id); ?>">
                <td style="color:var(--muted);font-size:12px"><?php echo e($i+1); ?></td>
                <td><strong style="color:var(--ink)"><?php echo e($project->title); ?></strong></td>
                <td style="max-width:200px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis"><?php echo e($project->description); ?></td>
                <td><span style="font-size:11px;background:rgba(232,88,10,.08);color:var(--accent);border:1px solid rgba(232,88,10,.2);border-radius:100px;padding:3px 10px;font-weight:700"><?php echo e($project->tag); ?></span></td>
                <td><code style="font-size:11px;color:var(--muted)"><?php echo e($project->thumb_type); ?></code></td>
                <td>
                    <div style="display:flex;gap:6px">
                        <button class="btn-outline-accent" onclick="openModal(<?php echo e($project->id); ?>,'<?php echo e(addslashes($project->title)); ?>','<?php echo e(addslashes($project->description)); ?>','<?php echo e($project->tag); ?>','<?php echo e($project->thumb_type); ?>',<?php echo e($project->sort_order); ?>)">Edit</button>
                        <button class="btn-danger-sm" onclick="deleteProject(<?php echo e($project->id); ?>)">Hapus</button>
                    </div>
                </td>
            </tr>
...
async function saveProject() {
    ...
    const url = id ? `/admin/projects/${id}` : '<?php echo e(route("admin.projects.store")); ?>';
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\MATKUL SEMS 6\PRAKTIKUM ABP\webpro\webprofile\resources\views/admin/projects.blade.php ENDPATH**/ ?>